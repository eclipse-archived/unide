<template>
  <div class="machine-message content">
    ...
    <img src="images/specification/v2/messagePayload.svg" alt="Class diagram of the Machine Message payload" title="Class diagram of the Machine Message payload" class="is-centered">

    <schemaDetail type="v2/message" :examples="$static.examples">
      <card :collapsed="true">
